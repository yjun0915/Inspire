...
fig01 = plt.figure(1, (4., 4.), 200)   # figure를 넘버링하여 지정(중복❎)
...
fig02.canvas.manager.window.geometry("+900+400")        # 문자열 형식만 지원하는 듯

ax1 = fig01.add_subplot(2, 2, 1)        # 기본적인 axes
ax2 = fig01.add_subplot(2, 2, 3)
ax3 = fig01.add_subplot(2, 2, (2, 4))   # 여러 인접한 axes를 묶어 하나로 표현
